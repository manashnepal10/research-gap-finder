...
- If the question cannot be answered from the provided context at all, respond with:
  "The uploaded papers do not contain sufficient information to answer this question."
